...
<div class="rg_layout">
    ...
    <div class="rg_center">
        <div class="rg_form">
            <form action="${pageContext.request.contextPath}/positions/toAdd" id="form" method="get">
                <table>
                    <c:if test="${!empty manager.username}">
                        <tr hidden>
                            <td class="td_left">部门号</td>
                            <td class="td_right">
                                <input type="text" name="did" id="eid" value="${pos.did}">
                            </td>
                        </tr>
                    </c:if>
                    <tr>
                        ...
                        <td class="td_right">
                            <input type="text" name="pname" id="username" placeholder="请输入职务名称">
    ...
    <div class="rg_right">
        <p>
            <a href="${pageContext.request.contextPath}/positions/showDP" style="text-decoration: none">返回</a>
        </p>
    </div>
