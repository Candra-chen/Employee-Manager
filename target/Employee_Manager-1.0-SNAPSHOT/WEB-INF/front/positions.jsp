...
<div id="total1">
    <div class="top">
        <c:if test="${!empty posList}"><a>职务列表</a></c:if>
    </div>
    <div class="main">
        <div>
            ...
            <input id="addTmplFile" type="button" value="添加职务" onclick="window.location.href='${pageContext.request.contextPath}/positions/ShowAdd'" />
           </c:if>
        ...
        <div>
            <table id="table1" cellspacing="0px">
                <tr class="tableTitle" align="center">
                    <td class="col1">职务号</td>
                    <td class="col1">职务名称</td>
                    <td class="col1">创建日期</td>
                    <td class="col1">操作</td>
                </tr>
                <c:forEach items="${posList}" var="list">
                    <tr align="center">
                        <td class="col1">${list.pid}</td>
                        <td class="col1">${list.pname}</td>
                        <td class="col1">${list.cdate}</td>
                        <td class="col1"> <a href="${pageContext.request.contextPath}/positions/toFix?pid=${list.pid}" style="text-decoration: none;">修改</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
