...
<div class="rg_layout">
    ...
    <div class="rg_center">
        <div class="rg_form">
            <form action="${pageContext.request.contextPath}/dept/Fix" id="form" method="get">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="td_right">
                            <input type="text" name="dname" id="username" placeholder="请输入部门名字" value="${dept.dname}">
                    ...
                    <tr>
                        ...
                        <td class="td_right">
                            <input type="text" name="duty_man" id="password" value="${dept.duty_man}">
                    ...
                    <tr>
                        ...
                        <td class="td_right"><input type="date" name="cdate" id="email" value="${dept.cdate}"></td>
                    </tr>
                    <tr>
                            <td colspan="2" id="td_sub"><input type="submit" id="btn_sub" value="修改"></td>
                        <c:if test="${!empty msge}">
                            <td colspan="2" id="td_sub">${msge}<a href="${pageContext.request.contextPath}/dept/showDE">返回</a></td>
                        </c:if>
                    </tr>
                </table>
